...
class PasteController {
    ...
    public ResponseEntity<Void> delete(@PathVariable String shortId, @AuthenticationPrincipal User user) {
        boolean isDeleted = pasteService.deleteByShortId(shortId, user);
